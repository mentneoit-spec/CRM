# CSV File Ready - Upload Instructions
...
### 4. Select File
```
Select: gravity-crm/sample-students-import.csv
```
...
✅ Visible in Students list  
✅ Visible in Class details  
...
1. Go to **Students** - verify all 10 appear
2. Go to **Classes** - verify students assigned
3. Go to **Dashboard** - verify count updated
...
| Field | Value |
|-------|-------|
| File Name | sample-students-import.csv |
| Location | gravity-crm/ |
| Headers | 8 columns |
| Rows | 10 students |
